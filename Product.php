...
if (isset($_POST['submit']))
{
    ...
    $sql = "INSERT INTO products (product_id,brand_name,provider,product_name,product_price,product_description,product_volume,product_image)
   VALUES ('$product_id','$brand_name','$provider','$product_name','$product_price','$product_description','$product_volume','$product_image')";
                            ...
                            <div class="col-md-12 div">
                                ...
                                <form action="" class="form-group" method="post">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"  name="provider" placeholder="Provider Name" class="form-control">
                                            </div>
                                            <br>
                                            <div class="col-md-6">
                                                <br>
                                                <label for="phone">product description</label>
                                                <input type="text"  name="product_description" placeholder="Provider Name" class="form-control">
                                            </div>
                                            <br>
                                            <div class="col-md-6">
